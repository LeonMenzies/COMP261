...
public abstract class GUI {
	/**
	 * defines the different types of movement the user can perform, the appropriate
	 * one is passed to your code when the move(Move) method is called.
	 */
	public enum Move {
	...
	/**
	 * Is called whenever a navigation button is pressed. An instance of the Move
	 * enum is passed, representing the button clicked by the user.
	 */
	 ...
	 */
	protected abstract void onMouseDragg(MouseEvent e);
	...
	/**
	 * @return the JTextField used as a search box in the top-right, which can be
	 *         queried for the string it contains.
	 */
		...
		if (UPDATE_ON_EVERY_CHARACTER) {
			...
			search.addKeyListener(new KeyAdapter() {
				public void keyReleased(KeyEvent e) {
					// don't fire an event on backspace or delete ??? WHYYYY
